import { r as reactExports, a1 as useComposedRefs, j as jsxRuntimeExports, o as cn, ai as shimExports, R as React2, aj as withSelectorExports, p as ReactDOM, B as Button, K as Link$1, ab as X, ak as InlineError, m as ExternalBlob } from "./index-CTFv-2ec.js";
import { I as Input } from "./input-DwHAfcRI.js";
import { L as Label } from "./label-D29vlFFL.js";
import { a as useControllableState, P as Primitive, b as composeEventHandlers, d as createContextScope } from "./index-PD-Y2fac.js";
import { a as usePrevious, u as useSize } from "./index-1QrRFWwm.js";
import { A as ArrowLeft } from "./arrow-left-VnbXslnE.js";
import { I as Image$1, U as Upload } from "./upload-BwnMjeFe.js";
...
var getEmbedUrlFromYoutubeUrl = (options) => {
  ...
  let outputUrl = `${getYoutubeEmbedUrl(nocookie, matches2[1] === "list")}${matches2[2]}`;
  const params = [];
  ...
  if (params.length) {
    outputUrl += `${matches2[1] === "list" ? "&" : "?"}${params.join("&")}`;
  }
  return outputUrl;
};
    ...
    return [
      {
        ...
        getAttrs: (el) => ({
          url: el.getAttribute("data-twitter-url")
        })
      }
    ];
  },
...
function ArticleForm({
  ...
  const editorImageInputRef = reactExports.useRef(null);
  const handleEditorImageFile = reactExports.useCallback((file) => {
    ...
    img.onload = () => {
      ...
      editor == null ? void 0 : editor.chain().focus().setImage({ src: base64 }).run();
    };
    img.src = url;
  }, []);
  const editor = useEditor({
    extensions: [
      index_default$4,
      index_default$3.configure({ inline: false, allowBase64: true }),
      index_default$2.configure({ types: ["heading", "paragraph", "image"] }),
      TextStyle,
      Color,
      index_default$1.configure({ multicolor: true }),
      index_default$6.configure({ openOnClick: false }),
      index_default$5,
      index_default.configure({ controls: true, nocookie: true, HTMLAttributes: { class: "youtube-embed-wrapper my-4" } }),
      Twitter
    ],
    content: initial.content || "",
    onUpdate: ({ editor: editor2 }) => {
      set("content", editor2.getHTML());
    }
  });
  reactExports.useEffect(() => {
  ...
  const fitInto4x3 = (file, targetSizeBytes = 1024 * 1024) => {
    return new Promise((resolve, reject) => {
      ...
      img.onload = async () => {
        ...
        const tryEncode = (q2) => new Promise(
    ...
    "form",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          coverPreview ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-lg overflow-hidden border border-border max-w-sm aspect-[4/3]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: coverPreview,
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 rounded-full bg-muted border border-border text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image$1, { className: "size-5" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "type-meta text-muted-foreground mt-0.5", children: "JPG, PNG, WebP. Any size up to 5MB." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "type-meta text-muted-foreground mt-0.5", children: "Fitted into 4:3 frame (no cropping). Auto-compressed under 1MB." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: isFullscreen ? "fixed inset-0 z-50 flex flex-col bg-card overflow-auto" : "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-1 px-2 py-2 bg-[oklch(0.28_0.025_50)] border border-border rounded-t-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  ...
                  onChange: (e) => {
                    ...
                    if (v === "p") editor == null ? void 0 : editor.chain().focus().setParagraph().run();
                    else editor == null ? void 0 : editor.chain().focus().toggleHeading({ level: parseInt(v) }).run();
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "p", children: "Normal" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-5 bg-[oklch(0.4_0.03_50)]" }),
              [
                { label: "B", title: "Bold", action: () => editor == null ? void 0 : editor.chain().focus().toggleBold().run(), active: editor == null ? void 0 : editor.isActive("bold") },
                { label: "I", title: "Italic", action: () => editor == null ? void 0 : editor.chain().focus().toggleItalic().run(), active: editor == null ? void 0 : editor.isActive("italic") },
                { label: "U", title: "Underline", action: () => {
                  var _a, _b;
                  return (_b = editor == null ? void 0 : (_a = editor.chain().focus()).toggleUnderline) == null ? void 0 : _b.call(_a).run();
                }, active: editor == null ? void 0 : editor.isActive("underline") },
                { label: "S", title: "Strike", action: () => editor == null ? void 0 : editor.chain().focus().toggleStrike().run(), active: editor == null ? void 0 : editor.isActive("strike") }
              ].map(({ label, title, action, active }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  title,
              ...
              ["left", "center", "right"].map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  title: `Align ${a}`,
                  onClick: () => editor == null ? void 0 : editor.chain().focus().setTextAlign(a).run(),
                  className: `w-7 h-7 text-xs rounded transition-colors ${(editor == null ? void 0 : editor.isActive({ textAlign: a })) ? "bg-[oklch(0.75_0.19_50)] text-[oklch(0.15_0.02_50)]" : "text-[#f0ebe0] hover:bg-[oklch(0.35_0.03_50)]"}`,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `w-7 h-7 text-xs rounded transition-colors ${(editor == null ? void 0 : editor.isActive("bulletList")) ? "bg-[oklch(0.75_0.19_50)] text-[oklch(0.15_0.02_50)]" : "text-[#f0ebe0] hover:bg-[oklch(0.35_0.03_50)]"}`,
                  children: "≡"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `w-7 h-7 text-xs rounded transition-colors ${(editor == null ? void 0 : editor.isActive("orderedList")) ? "bg-[oklch(0.75_0.19_50)] text-[oklch(0.15_0.02_50)]" : "text-[#f0ebe0] hover:bg-[oklch(0.35_0.03_50)]"}`,
                  children: "1."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `w-7 h-7 text-xs rounded transition-colors ${(editor == null ? void 0 : editor.isActive("blockquote")) ? "bg-[oklch(0.75_0.19_50)] text-[oklch(0.15_0.02_50)]" : "text-[#f0ebe0] hover:bg-[oklch(0.35_0.03_50)]"}`,
                  children: '"'
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-5 bg-[oklch(0.4_0.03_50)]" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onClick: () => {
                    var _a;
                    return (_a = editorImageInputRef.current) == null ? void 0 : _a.click();
                  },
                  className: "w-7 h-7 text-xs rounded text-[#f0ebe0] hover:bg-[oklch(0.35_0.03_50)] transition-colors",
                  children: "🖼"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", title: "Insert link", onClick: () => {
                const url = window.prompt("URL:");
                if (!url) return;
                const { from: from2, to, empty: empty2 } = editor.state.selection;
                if (empty2) {
                  editor == null ? void 0 : editor.chain().focus().insertContent({ type: "text", text: url, marks: [{ type: "link", attrs: { href: url } }] }).run();
                } else {
                  editor == null ? void 0 : editor.chain().focus().setLink({ href: url }).run();
                }
              }, className: "w-7 h-7 text-xs rounded text-[#f0ebe0] hover:bg-[oklch(0.35_0.03_50)] transition-colors", children: "🔗" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", title: "Embed YouTube or X/Twitter video/post", onClick: () => {
                ...
                if (isYoutube) {
                  editor == null ? void 0 : editor.chain().focus().setYoutubeVideo({ src: trimmed }).run();
                } else if (isTwitter) {
                  editor == null ? void 0 : editor.chain().focus().insertContent({ type: "twitter", attrs: { url: trimmed } }).run();
                } else {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onClick: () => editor == null ? void 0 : editor.chain().focus().clearNodes().unsetAllMarks().run(),
                  className: "w-7 h-7 text-xs rounded text-[#f0ebe0] hover:bg-[oklch(0.35_0.03_50)] transition-colors",
                  children: "Tx"
                }
              ),
