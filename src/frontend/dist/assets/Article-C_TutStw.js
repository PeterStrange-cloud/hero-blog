import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as cn, u as useCreatePaymentRequest, b as useVerifyPaymentRequest, L as LoaderCircle, B as Button, C as Copy, d as useParams, e as useIdentity, f as useQueryClient, g as useArticle, h as useUserAccess, i as CircleAlert, k as Link, m as motion, l as CategoryBadge, P as PremiumBadge, F as FreeBadge, n as formatTimestamp, o as Lock } from "./index-CIbPl6dp.js";
import { P as Primitive } from "./index-CV2_8MkX.js";
import { X, A as ArrowLeft } from "./x-Fj8MNVJs.js";
import { C as CircleCheckBig } from "./circle-check-big-CLowWGxY.js";
/**
...
function subaccountToHex(subaccount) {
  return Array.from(subaccount).map((b) => b.toString(16).padStart(2, "0")).join("");
}
...
function PaymentDialog({
  ...
  const title = paymentType === "unlock" ? "Unlock with HERO" : "Subscribe with HERO";
  const amountLabel = paymentType === "unlock" ? "1 HERO (100,000,000 e8s)" : "10 HERO (1,000,000,000 e8s)";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "dialog",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-md rounded-xl border border-border bg-card shadow-2xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-5 space-y-5", children: [
          isCreating && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Preparing payment address…" })
              ]
            }
          ),
          createError && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          req && !createError && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/80 leading-relaxed", children: "Open NNS (nns.ic0.app), go to your HERO tokens, and send a transfer to this address:" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wider", children: "Subaccount (hex)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "code",
                  {
                    ...
                    children: subaccountHex
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CopyButton, { value: subaccountHex, label: "subaccount" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            statusText && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: `text-sm font-medium text-center py-2 px-3 rounded-lg border ${isGranted ? "border-primary/40 bg-primary/10 text-primary" : pollingStatus === "not_found" ? "border-destructive/40 bg-destructive/10 text-destructive" : "border-border bg-muted text-muted-foreground"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-xs mb-1 font-medium uppercase tracking-wider", children: "ONE-TIME ACCESS" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl text-foreground", children: "1 HERO" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 right-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] bg-primary text-primary-foreground px-1.5 py-0.5 rounded font-medium uppercase tracking-wider", children: "BEST VALUE" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-xs mb-1 font-medium uppercase tracking-wider", children: "MONTHLY SUBSCRIPTION" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl text-foreground", children: "10 HERO" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Unlock all premium articles for 30 days." })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "size-4 mr-2" }),
